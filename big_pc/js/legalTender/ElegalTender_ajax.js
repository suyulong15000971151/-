	...
	$.ajax({
		...
		success: function(data1) {
			if(data1.code != "200") {
				...
				var topNumber = "CNDT Available&nbsp<span>：" + currentBalance + "</span>&nbsp&nbsp Frozen：" + freezeTheBalance;
				...
				$(agentList).each(function(i, n) {
					...
					if(pcUser != null) {
						if(pcUser.agentStatus == 0) {
							if(type1 == 0) {
								typeclass = "<div class='buyBtn fr' onclick='buyBtn(" + n.id + ")' style='width:66px'>Purchase</div>";
								orderclass = "<td class = 'girdSale'>" + n.orderNum + "</td>";
							} else {
								typeclass = "<div class='saleBtn fr'  onclick='saleBtn(" + n.id + ")' style='width:66px'>Sell out</div>";
								orderclass = "<td class = 'girdBuy'>" + n.orderNum + "</td>";
							}
						} else {
							//TODO 通知代理没有下单权限
							Message("The agent has no single permissions", "warm");
							if(type1 == 0) {
								typeclass = "<div class='buyBtn fr' style='width:66px'>Purchase</div>";
								orderclass = "<td class = 'girdSale'>" + n.orderNum + "</td>";
							} else {
								typeclass = "<div class='saleBtn fr' style='width:66px'>Sell out</div>";
								orderclass = "<td class = 'girdBuy'>" + n.orderNum + "</td>";
							}
						}
					} else {
						...
						if(type1 == 0) {
							typeclass = "<a href=" + loginUrl + "><div class='buyBtn fr' style='width:66px'>Purchase</div></a>";
							orderclass = "<td class = 'girdSale'>" + n.orderNum + "</td>";
						} else {
							typeclass = "<a href='" + loginUrl + "'><div class='saleBtn fr' style='width:66px'>Sell out</div></a>";
							orderclass = "<td class = 'girdBuy'>" + n.orderNum + "</td>";
						}
					}
...
function getAll(status, page, rows) {
	...
	var zhanwudingdan = "<div class='reminderText'>" +
		"<p>No completion of the order</p>" +
		"<p>Warm reminder: more than three pens cancel orders, will be frozen when the world single jurisdiction</p>" +
		"</div>";
					...
					$(agentTrList).each(function(i, n) {
						...
						if(n.type == 0) {
							if(n.status == 4) {
								...
								if(agentUserOrderSelectVO.bankCard != null && agentUserOrderSelectVO.bankCard != "") {
									...
									var payType1 = "<tr><td><div class='radio radios' onclick='changePayType(" + agentUserOrderSelectVO.id + ",1)'></div></td><td><img src='../../img/yinhangka.png'/></td><td style='display:none'>" + agentUserOrderSelectVO.bankCard + "</td>	<td>Bank card</td><td>" + payType1s[0] + "</td><td>" + payType1s[3] + "</td><td>" + payType1s[1] + "</td><td>" + payType1s[2] + "</td></tr>"
								...
								if(agentUserOrderSelectVO.alipay != null && agentUserOrderSelectVO.alipay != "") {
									...
									var payType2 = "<tr><td><div class='radio radios' onclick='changePayType(" + agentUserOrderSelectVO.id + ",2)'></div></td><td><img src='../../img/zhifubao.png'/></td><td style='display:none'>" + agentUserOrderSelectVO.alipay + "</td><td>Alipay</td><td>" + payType2s[0] + "</td><td>" +
								...
								if(agentUserOrderSelectVO.weChat != null && agentUserOrderSelectVO.weChat != "") {
									...
									var payType3 = "<tr><td><div class='radio radios' onclick='changePayType(" + agentUserOrderSelectVO.id + ",3)'></div></td><td><img src='../../img/weixin.png'/></td><td style='display:none'>" + agentUserOrderSelectVO.weChat + "</td><td>WeChat</td><td>" +
								...
								var result = "<div class='unfinishedOrder'><div class='unfinishedText'><div class='unfinishedTextTop'><div class='item'><input type='hidden' id='waitTimeInput" + agentUserOrderSelectVO.number + "' value=" + (agentUserOrderSelectVO.endDate / 1000).toFixed(0) + "><label>Order number :</label><span>" + agentUserOrderSelectVO.number + "</span></div>	<div class='item'><label>seller :</label><span>" + agentUserOrderSelectVO.name + "</span></div></div><div class='unfinishedTextCenter'>	<div class='unfinishedTextCenterL fl'><div class='typeText'>		" +
									"<p class='selectType'>Purchase</p><p class='typeNmae'>" + agentUserOrderSelectVO.sellInputType + "</p></div><div class='typeMessage'>" +
									"<p class='typeNumber'>" + agentUserOrderSelectVO.amountOfMoney + agentUserOrderSelectVO.sellOutType + "</p><div class='item'>	<label>Unit Price：</label><span>" + agentUserOrderSelectVO.num + agentUserOrderSelectVO.sellOutType + "/" + agentUserOrderSelectVO.sellInputType + "</span>" +
									"</div><div class='item'><label>Number：</label><span>" + agentUserOrderSelectVO.volumeOfTransactions + agentUserOrderSelectVO.sellInputType + "</span></div>	<p class='payType'>Choice of payment method</p><table class='table-condensed payTable'><tbody>" +
									payType4 + "	</tbody>	</table>	</div></div>	<div class='unfinishedTextCenterR fr'><div><p>Wait for payment:<span id=\"waitTime\" class='waitTime" + agentUserOrderSelectVO.number + "'>" + (agentUserOrderSelectVO.endDate / 1000).toFixed(0) + "</span>，Payment reference number&nbsp:&nbsp<span class='consult '>" + agentUserOrderSelectVO.id + "</span></p>	<div><div class='signBtn fl' onclick='showConfirmPay(" + agentUserOrderSelectVO.id + ")'>Marked as payment</div><div class='signMessage fl' style='line-height:24px'>" +
									"<img src='../../img/notice.png'/>After the payment is successful, please click the button to inform the other party</div></div><p class='cancelForm' onclick='showCancel(" + agentUserOrderSelectVO.id + ")'>Cancellation of order</p></div></div></div><div class='unfinishedTextBottom'>" +
							...
							if(n.status == 0) {
								...
								if(agentUserOrderSelectVO.bankCard != null && agentUserOrderSelectVO.bankCard != "") {
									var payType1s = agentUserOrderSelectVO.bankCard.split("&");
									var payType1 = "<tr><td><img src='../../img/yinhangka.png'/></td>	<td>Bank card</td><td>" + payType1s[0] + "</td>	<td>" + payType1s[3] + "</td><td>" + payType1s[1] + "</td><td>" + payType1s[2] + "</td></tr>"
									payType4 = payType4 + payType1;
								}
								if(agentUserOrderSelectVO.alipay != null && agentUserOrderSelectVO.alipay != "") {
									var payType2s = agentUserOrderSelectVO.alipay.split("&");
									var payType2 = "<tr><td><img src='../../img/zhifubao.png'/></td><td>Alipay</td><td>" + payType2s[0] + "</td><td>" + payType2s[1] +
										"</td><td><img src=\"../../img/erweima.png\" class='zfbImg' onclick='Img(\"" + payType2s[2] + "\")'/></td></tr>"
									payType4 = payType4 + payType2;
								}
								if(agentUserOrderSelectVO.weChat != null && agentUserOrderSelectVO.weChat != "") {
									var payType3s = agentUserOrderSelectVO.weChat.split("&");
									var payType3 = "<tr><td><img src='../../img/weixin.png'/></td>	<td>WeChat</td><td>" + payType3s[0] + "</td><td>" + payType3s[1] +
										"</td><td><img src=\"../../img/erweima.png\" class='wxImg' onclick='Img(\"" + payType3s[2] + "\")'/></td></tr>"
									payType4 = payType4 + payType3;
								}
								var result = "<div class='unfinishedWaitOrder'><div class='unfinishedText changTop2'><div class='unfinishedTextTop'>	<div class='item'><input type='hidden' id='waitTimeInput" + agentUserOrderSelectVO.number + "' value=" + (agentUserOrderSelectVO.endDate / 1000).toFixed(0) + "><label>Order number :</label><span>" + agentUserOrderSelectVO.number + "</span></div>	<div class='item'><label>seller :</label><span>" + agentUserOrderSelectVO.name + "</span></div><div class='item floatRight' onclick='floatRight(" + agentUserOrderSelectVO.phone + ")'>	<img src='../../img/call.png'/><span>Contact each other</span></div></div>	<div class='unfinishedTextCenter changeTop'><div class='unfinishedTextCenterL fl changeTop'>	<div class='typeText changeTop1'>		" +
									"<p class='selectType'>Purchase</p><p class='typeNmae'>" + agentUserOrderSelectVO.sellInputType + "</p></div><div class='typeMessage changeTop1'>" +
									"<p class='typeNumber'>" + agentUserOrderSelectVO.amountOfMoney + agentUserOrderSelectVO.sellOutType + "</p><div class='item'>	<label>Unit Price：</label><span>" + agentUserOrderSelectVO.num + agentUserOrderSelectVO.sellOutType + "/" + agentUserOrderSelectVO.sellInputType + "</span>" +
									"</div>	<div class='item'><label>Number：</label><span>" + agentUserOrderSelectVO.volumeOfTransactions + agentUserOrderSelectVO.sellInputType + "</span></div><table class='table-condensed payTable'><tbody>" +
									payType4 + "	</tbody>	</table>	</div></div> <div class='unfinishedTextCenterR fr changeTop paddTop'><p>Wait for the other's coin，<span id=\"waitTime\" class='waitTime" + agentUserOrderSelectVO.number + "'>" + (agentUserOrderSelectVO.endDate / 1000).toFixed(0) + "</span>，Payment reference number&nbsp:&nbsp<span class='consult'>" + agentUserOrderSelectVO.id +
						...
						if(n.type == 1) {
							if(n.status == 0) {
								...
								if(agentUserOrderSelectVO.weChat != null && agentUserOrderSelectVO.weChat != "") {
									var payType3s = agentUserOrderSelectVO.weChat.split("&");
									var payType3 = "<tr><td><img src='../../img/weixin.png'/></td>	<td>WeChat</td><td>" + payType3s[0] + "</td><td>" + payType3s[1] + '</td><td><img src=\"../../img/erweima.png\" class="wxImg" onclick="Img(\'' + payType3s[2] + '\')"/></td></tr>'
									payType4 = payType4 + payType3;
								}
								var result = "<div class='unfinishedDischargeOrder '><div class='unfinishedText changTop2'><div class='unfinishedTextTop'>	<div class='item'><input type='hidden' id='waitTimeInput" + agentUserOrderSelectVO.number + "' value=" + (agentUserOrderSelectVO.endDate / 1000).toFixed(0) + "><label>订单号 :</label><span>" +
									agentUserOrderSelectVO.number + "</span></div>	<div class='item'><label>Buyer :</label><span>" + agentUserOrderSelectVO.name +
									"</span>	</div><div class='item floatRight' onclick='floatRight(" + agentUserOrderSelectVO.phone + ")'><img src='../../img/call.png'/><span>Contact each other</span></div></div><div class='unfinishedTextCenter changeTop'>	<div class='unfinishedTextCenterL fl changeTop'>	<div class='typeText changeTop1 '><p class='selectType changecolor'>Sell out</p><p class='typeNmae changecolor'>" + agentUserOrderSelectVO.sellOutType + "</p></div>	" +
									"<div class='typeMessage changeTop1'><p class='typeNumber'>" + agentUserOrderSelectVO.amountOfMoney + agentUserOrderSelectVO.sellInputType + "</p><div class='item'><label>Unit Price：</label><span>" + agentUserOrderSelectVO.num + agentUserOrderSelectVO.sellInputType + "/" + agentUserOrderSelectVO.sellOutType + "</span></div>	<div class='item'>	<label>Number：</label><span>" + agentUserOrderSelectVO.volumeOfTransactions + agentUserOrderSelectVO.sellOutType + "</span></div>	<div class='blank5'></div><table class='table-condensed payTable'>	<tbody>	" +
									payType4 +
									"</tbody></table>" +
									"</div></div><div class='unfinishedTextCenterR fr changeTop paddTop1'><p>To be released，<span id=\"waitTime\" class='waitTime" + agentUserOrderSelectVO.number + "'>" + (agentUserOrderSelectVO.endDate / 1000).toFixed(0) + "</span>，Payment reference number&nbsp:&nbsp<span class='consult '>" + agentUserOrderSelectVO.id +
									"</span></p>	<div class='signBtn fl' onclick='showDischarged(" + agentUserOrderSelectVO.id + ")'>Release CNDT</div></div>	</div><div class='unfinishedTextBottom'>" +
									agentUserOrderSelectVO.tradeNotice
							...
							if(n.status == 4) {
								var result = "<div class='unfinishedSaleOrder '>	<div class='unfinishedText changTop2'><div class='unfinishedTextTop'><div class='item'><input type='hidden' id='waitTimeInput" + agentUserOrderSelectVO.number + "' value=" + (agentUserOrderSelectVO.endDate / 1000).toFixed(0) + "><label>Order number :</label><span>" + agentUserOrderSelectVO.number + "</span></div><div class='item'>" +
									"<label>Buyer :</label><span>" + agentUserOrderSelectVO.name + "</span></div><div class='item floatRight' onclick='floatRight(" + agentUserOrderSelectVO.phone + ")'>	<img src='../../img/call.png'/><span>Contact each other</span></div></div>	<div class='unfinishedTextCenter changeTop'>		" +
									"<div class='unfinishedTextCenterL fl changeTop'>	<div class='typeText changeTop1 '><p class='selectType changecolor'>Sell out</p><p class='typeNmae changecolor'>" + agentUserOrderSelectVO.sellOutType + "</p></div>	<div class='typeMessage changeTop1'>	<p class='typeNumber'>" + agentUserOrderSelectVO.amountOfMoney + agentUserOrderSelectVO.sellInputType + "</p>		" +
									"<div class='item'><label>Unit Price：</label><span>" + agentUserOrderSelectVO.num + agentUserOrderSelectVO.sellInputType + "/" + agentUserOrderSelectVO.sellOutType + "</span></div><div class='item'><label>Number：</label><span>" + agentUserOrderSelectVO.volumeOfTransactions + agentUserOrderSelectVO.sellOutType + "</span>	</div><p></p></div>	</div><div class='unfinishedTextCenterR fr changeTop paddTop'>" +
									"<p>Buyer's payment，<span id=\"waitTime\" class='waitTime" + agentUserOrderSelectVO.number + "'>" + (agentUserOrderSelectVO.endDate / 1000).toFixed(0) + "</span>，Payment reference number &nbsp:&nbsp<span class='consult '>" + agentUserOrderSelectVO.id +
									"</span></p></div>	</div><div class='unfinishedTextBottom'>" +
									agentUserOrderSelectVO.tradeNotice
				...
				if(agentTrList.length > 0) {
					...
					$(agentTrList).each(function(i, n) {
						...
						if(agentUserOrderSelectVO.bankCard != null && agentUserOrderSelectVO.bankCard != "") {
							...
							trPayType = "<td><ul><li class=\"trStyle\">Transfer mode</li><li><label>Transfer mode:</label><span>Bank card</span></li><li><label>Full name:</label><span>" + payType[0] +
								"</span></li><li><label>Bank:</label><span>" + payType[1] + "</span></li><li><label>Branch:</label><span>" + payType[2] + "</span></li></ul></td>"
						}
						if(agentUserOrderSelectVO.alipay != null && agentUserOrderSelectVO.alipay != "") {
							var payType = agentUserOrderSelectVO.alipay.split("&");
							trPayType = "<td><ul><li class=\"trStyle\">Transfer mode</li><li><label>Transfer mode:</label><span>Alipay</span><img src=\"../../img/erweima.png\" class='zfbImg' onclick='Img(\"" + payType[2] + "\")'/></li><li><label>Full name:</label><span>" + payType[0] +
								"</span></li></ul></td>"
						}
						if(agentUserOrderSelectVO.weChat != null && agentUserOrderSelectVO.weChat != "") {
							var payType = agentUserOrderSelectVO.weChat.split("&");
							trPayType = "<td><ul><li class=\"trStyle\">Transfer mode</li><li><label>Transfer mode:</label><span>WeChat</span><img src=\"../../img/erweima.png\" class='wxImg' onclick='Img(\"" + payType[2] + "\")'/></li><li><label>Full name:</label><span>" + payType[0] +
								"</span></li></ul></td>"
						}
						...
						if(agentUserOrderSelectVO.status == 2) {
							statusName = "Transaction completion";
						}
						if(agentUserOrderSelectVO.status == 1) {
							statusName = "Merchant cancellation";
						}
						if(agentUserOrderSelectVO.status == 3) {
							statusName = "User cancellation";
						}
						var data = "";
						...
						if(agentUserOrderSelectVO.status == 2) {
							data = "<td class=\"tdStyle\"><ul><li class=\"trStyle\">Confirmation time</li><li><label>Completion time:</label><span>" + newDate.format('yyyy-MM-dd hh:mm:ss') + "</span></li></ul></td>";
							var table = "<tr class='trList' ><td>" + agentUserOrderSelectVO.number + "</td><td class='typecolor'>" + type + "</td><td>" + statusName + "</td><td>" + tokentype + "</td><td>" + agentUserOrderSelectVO.num + "</td><td>" + trNumType + "</td><td>" + trNumMyType + "</td><td>" + newDate.format('yyyy-MM-dd hh:mm:ss') +
								"</td></tr><tr style=\"display: none;\">" + trPayType + "<td class=\"tdStyle\"><ul><li class=\"trStyle\">Seller information</li><li><label>Full name:</label><span>" + agentUserOrderSelectVO.name + "</span></li></ul></td>" + data + "<td></td><td></td><td></td><td></td><td></td></tr>";

						} else {
							data = "<td class=\"tdStyle\"><ul><li class=\"trStyle\">Cancellation of time</li><li><span>" + newDate.format('yyyy-MM-dd hh:mm:ss') + "</span></li></ul></td>";
							var table = "<tr class='trList'><td>" + agentUserOrderSelectVO.number + "</td><td class='typecolor'>" + type + "</td><td>" + statusName + "</td><td>" + tokentype + "</td><td>" + agentUserOrderSelectVO.num + "</td><td>" + trNumType + "</td><td>" + trNumMyType + "</td><td>" + newDate.format('yyyy-MM-dd hh:mm:ss') +
								"</td></tr><tr style=\"display: none;\" class='trListShow'><td class=\"tdStyle\"><ul><li class=\"trStyle\">Seller information</li><li><label>Full name:</label><span>" + agentUserOrderSelectVO.name + "</span></li></ul></td>" + data + "<td></td><td></td><td></td><td></td><td></td><td></td></tr>";
...
function buyBtn(id) {
	if(pcUser == null) {
		...
		Message("The user is not logged in", "error");
		return;
	}
	if(pcUser != null) {
		if(pcUser.realNameStatus != 1) {
			Message("Ask for real name certification", "error");
			return;
		}
	}
	if(pcUser != null) {
		if(pcUser.fundsStatus == 0) {
			Message("Please go to the personal center first - security settings to bind the fund password.", "error");
			return;
		}
	}
	selectuserBalance()
	...
	$("#buying").show();
	$(".buyTitle .titleText").html("Purchase")
	$("body").css("overflow", "hidden");
	$('#buyBtn_tokenNum').bind('input propertychange', function() {
		if(decimal($(this).val())) {
			Message("The number of buying and selling should not be less than 2 decimal points", "win");
...
function saleBtn(id) {
	...
	if(statusPayment == 0) {
		Message("Please set up the way of payment", "error");
		return;
	}
	selectuserBalance()
	var data = {
	...
	$("#buying").show();
	$(".buyTitle .titleText").html("Sell out")
	$("body").css("overflow", "hidden");
	$('#buyBtn_tokenNum').bind('input propertychange', function() {
		if(decimal($(this).val())) {
			Message("The number of buying and selling should not be less than 2 decimal points", "win");
...
function payForm(id) {
	...
	if(inputhiddenId == null) {
		Message("Please choose the way of payment", "win");
		return;
	}
	var data = {};
	if(inputhiddenId == 1) {
...
function dischargedForm(id) {
	...
	if(dischargedImg == "../../img/selecrbox.png") {
		Message("Please check out", "error");
		return;
	}
	if($(".dischargedPasInput").val() == null && $(".dischargedPasInput").val() == "") {
		Message("Please enter the capital cipher", "error");
		return;
	}
	$("#discharged").hide();
	$("body").css("overflow", "visible");
...
function buying(id, type) {
	...
	if(pcUser != null) {
		if(buyBtn_tokenNum <= 0) {
			Message("The number of sales cannot be 0", "warm");
			return;
		}
	}
	$("#buyingBar").attr("onclick", "");
				...
				if(times != -1) {
					if(times <= 0) {
						...
						if(day == '0' && hour == '00' && minute == '00' && second == '00') {
							...
							if(hour != '00') {
								$(".waitTime" + n).append(hour + "H" + minute + "Min" + second + "S");
							} else {
								if(minute == '00') {
									$(".waitTime" + n).append(second + "S");
								} else {
									$(".waitTime" + n).append(minute + "Min" + second + "S");
								}
							}
